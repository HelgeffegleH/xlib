...
class bases {
	...
	class cleanUpObjError {
		; extends cleanupBase extends getErrorBase, see xlib.bases.dummy
	}
	class cleanupBase {
		; Methods
	...
	class extObj {
		; cleanUpObjError
		static ___dummy0 := xlib.bases.extObj.extend(xlib.bases.cleanUpObjError, xlib.bases.cleanupBase, xlib.bases.getErrorBase)
		extend(o, bases*){
			; o extends bases*
			local
			for k, base in bases
